...
<head>
    ...
    <title>T.e-commerce - Login</title>
      ...
      <a class="navbar-brand text-light" href="../index.php"><img src="../img/Logo/logo final 4k muito cara encurtado pra ficar no fit - PNG.png" alt="" width="80px" height="90px"></a>
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item" href="../Script/scriptlogout.php"> Sair </a></li>
            ...
            ?>
              <li class="nav-item">
                <a class="nav-link active text-light" aria-current="page" href="./formCadUsuario.php">Cadastrar</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active text-light" aria-current="page" href="./formlogin.php">Login</a>
              </li>
...
<div class="row col col-10 col-sm-3 m-5 bg-light p-3 rounded">
    <div class="d-flex justify-content-center">
    ...
    <form action="../Script/scriptlogin.php" method="POST">
        ...
        <input type="password" name="senha" id="" class="form-control mb-4" required>
        <input type="submit" class="form-control btn btn-danger mb-3" value="Login">
        <p class="text-muted"> Não tem conta? <a class="text-decoration-none text-danger" href="../form/formCadUsuario.php">Cadastre-se</a> </p>
    </form>
</div>
</main>
