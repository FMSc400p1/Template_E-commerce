...
<head>
    ...
    <title>T.e-commerce - Cadastrar Produto</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-danger text-light">
      ...
      <a class="navbar-brand text-light" href="../index.php"><img src="../img/Logo/logo final 4k muito cara encurtado pra ficar no fit - PNG.png" alt="" width="80px" height="90px"></a>
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="./formUpdateUsuario.php?id=<?=$_SESSION['id'];?>">Editar conta</a></li>
  ...
  <main class="d-flex justify-content-center flex-column align-items-center">
        ...
        <div class="m-5 bg-light p-3 row col col-10 col-sm-6">
            <div class="d-flex justify-content-center">
                <h1 class="text-danger mt-3 ">Cadastrar</h1>
            </div>
            <form action="../Script/scriptCadProd.php" method="POST" enctype="multipart/form-data">
                <label for="" class="form-label mt-3 mx-3">Nome</label>
                <input type="text" name="nome" id="" class="form-control" required>
                <label for="" class="form-label mt-3 mx-3">Marca</label>
                <input type="text" name="marca" id="" class="form-control" required>
                <label for="" class="form-label mt-3 mx-3">Data de Validade</label>
                <input type="date" name="datav" id="" class="form-control" required>
                <label for="" class="form-label mt-3 mx-3">Preço</label>
                <input type="text" name="preco" id="" class="form-control" required>
                <label for="">Descrição do Produto:</label>
                <textarea name="desc" id="" cols="30" rows="10"></textarea>
                <label for="" class="form-label mt-3 mx-3">Imagem 1:</label>
                <input type="file" name="file1" class="form-control">
                <label for="" class="form-label mt-3 mx-3">Imagem 2:</label>
                <input type="file" name="file2" class="form-control">
                <label for="" class="form-label mt-3 mx-3">Imagem 3:</label>
                <input type="file" name="file3" class="form-control">
                <input type="hidden" name="tipo" value="comum">
                <input type="submit" class="form-control btn btn-danger mb-3 mt-3" value="Cadastrar">
            </form>
        </div>
    </main>
